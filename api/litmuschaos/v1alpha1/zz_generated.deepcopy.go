...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DynatraceProbeInputs) DeepCopyInto(out *DynatraceProbeInputs) {
	*out = *in
	out.Comparator = in.Comparator
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DynatraceProbeInputs.
func (in *DynatraceProbeInputs) DeepCopy() *DynatraceProbeInputs {
	if in == nil {
		return nil
	}
	out := new(DynatraceProbeInputs)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProbeAttributes) DeepCopyInto(out *ProbeAttributes) {
	*out = *in
	...
	if in.DynatraceProbeInputs != nil {
		in, out := &in.DynatraceProbeInputs, &out.DynatraceProbeInputs
		*out = new(DynatraceProbeInputs)
		**out = **in
	}
